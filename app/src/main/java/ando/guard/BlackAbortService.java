        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:// 来电铃声状态
                    if (BlackNumberDao.INSTANCE.queryNumber(incomingNumber)) {
                        // 查询拦截模式
                        String mode = BlackNumberDao.INSTANCE.queryMode(incomingNumber);
    ...
    static class SMSAbort extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (Object object : objects) {
                ...
                if (BlackNumberDao.INSTANCE.queryNumber(phone)) {
                    // 查询拦截模式
                    String mode = BlackNumberDao.INSTANCE.queryMode(phone);
